...
- 원문 문서: https://github.com/microsoft/autogen/blob/main/dotnet/test/Microsoft.AutoGen.Integration.Tests.AppHosts/HelloAgentTests/README.md
- 미러 경로: `dotnet/test/Microsoft.AutoGen.Integration.Tests.AppHosts/HelloAgentTests/README.md`
